...
# Ref - https://towardsdatascience.com/reinforcement-learning-tile-coding-implementation-7974b600762b
...
class ValueFunctionWithTile(ValueFunctionWithApproximation):
    def __init__(self,
        ...
        num_tilings_in_dim = (np.ceil((state_high - state_low) / tile_width) + 1)
        num_tilings_in_dim = num_tilings_in_dim.astype(int)
